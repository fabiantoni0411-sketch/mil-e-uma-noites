...
export default function AcompanharPage() {
  ...
  return (
    ...
    >
      ...
      >
        Digite o telefone que você usou no pedido para ver o status.
      </p>
          ...
          {pedidos.map((p) => (
            <div
              ...
              style={{
                ...
                border: '1px solid rgba(205,159,79,.3)',
                borderRadius: 14,
                padding: 16,
                marginBottom: 14,
              }}
              ...
              >
                <span
                  style={{
                    ...
                    borderRadius: 20,
                    background:
                      (STATUS_COR[p.status] || '#888') + '22',
                    color: STATUS_COR[p.status] || '#ccc',
                  }}
                >
                  {p.status}
                </span>
